...
//        });	
        ...
        ifremenew.innerHTML = "<iframe src='mostrarreportecomisaria.asp?flota="+$("#flota").val() +"' style='border: none; width:100%; height:100%; background-color:transparent;' id='mostrarfechas'></iframe>";
