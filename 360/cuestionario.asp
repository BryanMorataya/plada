...
<%
	...
	Conn.Open strds2
	SQL = "SELECT id_tipo_vehiculo,tipo_vehiculo FROM tipo_vehiculo"
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
							 ...
							 %>
                                <tr>
                                    <td><% = RS("id_tipo_vehiculo")%></td>
                                    <td><% = RS("tipo_vehiculo")%></td>
                                    <td>
                                     <span class="btn-group">
                                        <a href="viewcuestionario.asp?ID=<%  = RS("id_tipo_vehiculo")%>" class="btn btn-small"><i class="icon-search"></i>Detalle</a> 
                                     </span>
                                   </td>
                                </tr>
								<%
