                      ...
                      <form class="mws-form" action="widgets.html">
                            <div class="mws-form-cols clearfix">
                                    <div class="mws-form-col-2-8 alpha">
                                        <label class="mws-form-label"><span class="white">Seleccione Mes</span></label>
                                    ...
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label"><span class="white">Seleccione a&ntilde;o</span></label>
                                        <div class="mws-form-item large">
                                          <select id="mes1">
...
//        });	
        ...
        ifremenew.innerHTML = "<iframe src='mostrarreportemensual.asp?mes="+$("#mes").val()+"&mes1="+ $("#mes1").val() +"' style='border: none; width:100%; height:100%; background-color:transparent;' id='mostrarfechas'></iframe>";
