                ...
                <!-- Panels Start -->
             	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" name="nveh" method="post" action="edipil.asp">
                            ...
                            <div class="mws-form-cols clearfix">
                                <div class="mws-form-col-5-8 alpha">
                                    ...
                                    <div class="mws-form-item large">
                                        <input id="nombre" type="text" size="300" maxlength="150" name="nombre"  value = "<%=rs("nombre") %>"/>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-col-2-8 alpha">
                                    ...
                                    <div class="mws-form-item large">
                                        <input id="licencia" type="text" size="150" maxlength="75" name="licencia"  value = "<%=rs("licencia") %>"/>
                                    </div>
                                </div>
                                <div class="mws-form-col-2-8">
                                    <label class="mws-form-label">Numero de Identificacion</label>
                                    <div class="mws-form-item large">
                                        <input id="ident" type="text" maxlength="75" name="ident"  value = "<%=rs("docidentificacion") %>" />
                                    </div>
                                </div>
                                <div class="mws-form-col-2-8">
                                    <label class="mws-form-label">Numero de Telefono</label>
                                    <div class="mws-form-item large">
                                        <input id="telef" type="text" maxlength="50" name="telef" value = "<%=rs("telefono") %>"/>
                                    </div>
                                </div>
                            </div> 
