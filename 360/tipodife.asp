                ...
                <!-- Panels Start -->
             	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span>Ingreso de nuevos tipos de diferencial</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" name="nveh" method="post" action="addtidif.asp">
                        	<div class="mws-form-cols clearfix">
                                <div class="mws-form-col-5-8 alpha">
                                    <label class="mws-form-label">Descripcion</label>
                                    <div class="mws-form-item large">
                                        <input id="descripcion" type="text" size="300" maxlength="150" name="descripcion" value="na"/>
                                    </div>
                                </div>
                            </div>                   
