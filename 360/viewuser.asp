...
<%
	...
	Conn.Open strds2
	SQL = "SELECT * FROM userw order by ID asc"
                            ...
                            <tbody>
							 ...
							 %>
                                <tr>
                                    ...
                                    <td><% verrol RS("nrol")%></td>
                                    <td><span class="btn-group">
                                    		<a href="edituser.asp?UserID=<%  = RS("ID")%>" class="btn btn-small"><i class="icon-pencil-2"></i>Editar</a> 
                                       		<a href="deluser.asp?UserID=<%  = RS("ID")%>" class="btn btn-small"><i class="icon-trash"></i>Borrar</a>
                                      		<a href="aduser.asp" class="btn btn-small"><i class="icon-pencil-2"></i>Nuevo</a>
                                        </span>
                                    </td>
                                </tr>
								<%
