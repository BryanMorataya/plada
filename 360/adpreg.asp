...
<%
	...
	if Request.Form("Update") = "agregar" Then
        ...
        sqladd = "insert into preguntad_360 (idPreguntae,descripcionpregunta,sisUsuario) "
        sqladd = sqladd & "values ("&StrParam&",'"&vFirstName&"','" & session("Username") & "')"
        Conn.execute sqladd
		response.Redirect("detcuest.asp?UserID="&StrParam)
	 Else 
%>
<!-- Viewport Metatag -->
                    	...
                    	<form class="mws-form" name="nveh" method="post" action="#">
                        	<div class="mws-form-cols clearfix">
                                <div class="mws-form-col-5-8 alpha">
                                    <label class="mws-form-label">Descripcion de la pregunta</label>
                                    <div class="mws-form-item large">
                                        <input id="FirstName" type="text" size="300" maxlength="150" name="FirstName"/>
                                    </div>
                                </div>
                            </div>                   
