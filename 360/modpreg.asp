...
<%
	...
	Conn.Open strds2
	SQL = "SELECT * FROM preguntad_360 WHERE ID="&StrParam
	...
	if Request.Form("Update") = "Actualizar" Then
		...
		SQLUpdate = "UPDATE preguntad_360 SET "
		SQLUpdate = SQLUpdate & "descripcionpregunta='"&Firstname 
		SQLUpdate = SQLUpdate & "' WHERE ID=" & StrParam
        response.write sqlupdate
		Conn.execute SQLUpdate
		response.Redirect("detcuest.asp?UserID="&Request.QueryString("ParamID"))
	 Else 
%>
<head>
<meta charset="utf-8" />
                        	...
                        	<div class="mws-form-cols clearfix">
                                <div class="mws-form-col-5-8 alpha">
                                    ...
                                    <div class="mws-form-item large">
                                        <input id="FirstName" type="text" size="300" maxlength="150" name="FirstName" value="<% = RS("descripcionpregunta")%>"/>
                                    </div>
                                </div>
                            </div>                    
                    		<div class="mws-button-row">
                    			<input type="submit" name="Update" id="Update" value="Actualizar" class="btn btn-primary" />
                    		</div>
                        </form>
                    </div>
                </div>
