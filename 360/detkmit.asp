                ...
                <!-- Panels Start -->
             	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span>Ingreso de 360 por vehiculo</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" name="nveh" method="get" action="detkmitd2.asp">
                        	<div class="mws-form-cols clearfix">
                                <div class="mws-form-col-2-8 alpha">
                                     <label class="mws-form-label"># de Unidad a buscar</label>
                                       <div class="mws-form-item clearfix">
                     		            <select id="uhid" name="uhid">
                                         <option value = "0">Seleccionar</option>  
                  						     <%llenaveh3 x1 %>
               					        </select>
                                        <input type="hidden" value="<%=request.QueryString("tipv")%>" name="tipv">
               				           </div>
                                </div>  
                            </div>
