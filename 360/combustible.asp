                ...
                <!-- Panels Start -->
             	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span>Ingreso de Tipo De  Combustible</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" name="nveh" method="post" action="addlieje.asp">
                        	<div class="mws-form-cols clearfix">
                                <div class="mws-form-col-5-8 alpha">
                                    <label class="mws-form-label">Vehiculo</label>
								...
								<div class="mws-form-col-5-8 alpha">
                                    <label class="mws-form-label">Tipo De Combustible</label>
                                    <div class="mws-form-item large">
                    		...
                    		<div class="mws-button-row">
                    			<input id="btngrabar"  type="button" value="Grabar" name="Grabar" class="btn btn-primary" onClick="actualizarcombustible()"/>
