                  ...
                  <div class="mws-panel-body no-padding">
                      <form class="mws-form" action="widgets.html">
                            <div class="mws-form-cols clearfix">
                                    ...
                                    <%else%>
                                    <input type="hidden" value="<%=session("flotilla")%>" id="flota">
                                    <%end if%>
                            </div>
                      </form>                    
                  </div> 
...
//        });	
        ...
        ifremenew.innerHTML = "<iframe src='mostrarReportepilotosfecha.asp?inicial="+$("#inicial").val()+"&final="+ $("#final").val() +"' style='border: none; width:100%; height:100%; background-color:transparent;' id='mostrarreportepilotos'></iframe>";
