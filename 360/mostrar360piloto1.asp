...
Dim Conn ' Open Database Connection
	...
	Conn.Open DSN
	quev = session("empn")
	     SQL="select nombre,edad,telefono from pilotos where  not id in(select cheq.piloto from ichequeos cheq where cheq.fecha between '"&inicial&"' and '"&final&"' group by cheq.piloto)"
...
<body style="background-color:transparent;">
    ...
    <div class="mws-panel-body no-padding">
        ...
        <thead><tr><th>Fecha</th><th>Edad</th><th>Telefono</th></tr></thead>
    	<%While Not Rs.Eof%>
         <tr >
        	<td><%=(RS("nombre"))%></td>
            <td><%=RS("edad")%></td>
