...
<body>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
              <div id="mws-error-page"  width: 1070px;">
                    <table style="border-style: outset; width: 100%;" border="1">
                        <tr>
                            ...
                            <td class="style1">
                                <% = rs("CODIGO") %>
                                <input id="nunidad" type="hidden" name="nunidad" value = "<% = nunit %>"/>
                            </td>
                            <td>
                                tipo de servicio
                            </td>
                        ...
                        <tr>
                            ...
                            <td >
                                Fecha de Ingreso</td>
                          <td >
                               <input class='text' type='text' name='fecha' id='date2' autocomplete='off' value="<%=date %>">
                                <script type="text/javascript">
                                    $("#date2").glDatePicker({ cssName: "android" });
						        </script> 
                        </tr>
                         <tr>
                            <td >
                    ...
                    <br />
                    <div id="img1" style="top:150px; left:100px; position:absolute; width: 1070px;">
                    <table style="border-style: outset; width: 100%;" border="0">
                      <tr>
                        <td>
                            <img alt="lizq" src="images/laizquierdo.png" width="600" height="150" />
                        </td>
                        <td>
                         <img alt="lizq" src="images/frente.png" width="200" height="150" />
                        </td>
                      </tr>
                       <tr>
                        <td>
                            <img alt="lizq" src="images/laderecho.png" width="600" height="150" />
                        </td>
                        <td>
                         <img alt="lizq" src="images/atras.png" width="200" height="150" />
                        </td>
                      </tr>
                     </table>
                    </div>
                    <br />
                    <div id="tfrente" style="top:605px; left:40px; position:absolute; width: 500px;">
                     <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                             Frente
                            </div>
                          </td>
                         </tr>
                    ...
                    <div id="tinterior" style="top:605px; left:550px; position:absolute; width: 550px;">
                     <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="radio13" type="radio" checked="checked" 
                               ...
                               X<input id="radio14" type="radio" name="i1" onclick="setcolor('tvideodvd',1)" value="1"/>
                           </td>
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="radio15" type="radio" checked="checked" name="i2" onclick="setcolor('tMonitores',0)" value="0"/> 
                               X<input id="radio16" type="radio" name="i2" onclick="setcolor('tMonitores',1)" value="1"/>
                           </td>
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="Radio17" type="radio" checked="checked" name="i3" onclick="setcolor('tstereo',0)" value="0"/> 
                               X<input id="Radio18" type="radio" name="i3" onclick="setcolor('tstereo',1)" value="1"/>
                           </td>
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="Radio19" type="radio" checked="checked" name="i4" onclick="setcolor('tbutacas',0)" value="0"/> 
                               X<input id="Radio20" type="radio" name="i4" onclick="setcolor('tbutacas',1)" value="1"/>
                           </td>
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="Radio21" type="radio" checked="checked" name="i5" onclick="setcolor('tairec',0)" value="0"/> 
                               X<input id="Radio22" type="radio" name="i5" onclick="setcolor('tairec',1)" value="1"/>
                           </td>
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="Radio23" type="radio" checked="checked" name="i6" onclick="setcolor('tlucesi',0)" value="0"/> 
                               X<input id="Radio24" type="radio" name="i6" onclick="setcolor('tlucesi',1)" value="1"/>
                           </td>
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="Radio25" type="radio" checked="checked" name="i7" onclick="setcolor('tfundas',0)" value="0"/> 
                               X<input id="Radio26" type="radio" name="i7" onclick="setcolor('tfundas',1)" value="1"/>
                           </td>
                      ...
                      <tr>
                           ...
                           <td>
                              ✓<input id="Radio27" type="radio" checked="checked" name="i8" onclick="setcolor('tbano',0)" value="0"/> 
                               X<input id="Radio28" type="radio" name="i8" onclick="setcolor('tbano',1)" value="1"/>
                           </td>
                    ...
                    <div id="lderecho" style="top:830px; left:40px; position:absolute; width: 500px;">
                        <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                         ...
                         <tr>
                           ...
                           <td>
                              ✓<input id="radio29" type="radio" checked="checked" 
                                   name="ld1" onclick="setcolor('tventanillasd',0)" value="0"/> 
                               X<input id="radio30" type="radio" name="ld1" onclick="setcolor('tventanillasd',1)" value="1"/>
                           </td>
                    ...
                    <div id="lizquierdo" style="top:895px; left:550px; position:absolute; width: 550px;">
                        <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                    ...
                    <div id="posterior" style="top:1025px; left:40px; position:absolute; width: 500px;">
                      <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                    ...
                    <div id="eseg" style="top:1090px; left:550px; position:absolute; width: 550px;">
                      <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;">
                    ...
                    <div id="docs" style="top:1250px; left:40px; position:absolute; width: 500px;">
                     <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                    ...
                    <div id="herramienta" style="top:1225px; left:550px; position:absolute; width: 550px;">
                     <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;" >
                    ...
                    <div id="Operaciones" style="top:1475px; left:40px; position:absolute; width: 1050px;">
                     <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                          <td colspan="4" bgcolor="black">
                            <div style="font-family: arial, Helvetica, sans-serif; font-size: 18px; text-align: center; color: #FFFFFF;">
                             Operacion de la unidad y desempeño
                            </div>
                          </td>
                         </tr>
                         <tr>
                    ...
                    <div id="ipiloto" style="top:1985px; left:40px; position:absolute; width: 1050px;">
                     <table style="border-style: outset; width: 100%;" border="1">
                         <tr>
                        ...
                        <td align="center" colspan="5">
                            <input id="Submit2" type="submit" value="Grabar" />
                        </td>
                     </tr>
                     </table>
              </div>
