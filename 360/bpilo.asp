...
<%
	...
	Conn.Open strds2
	SQL = "select id,nombre,licencia,telefono from pilotos order by id"
            ...
            <div class="container">
                ...
                <!-- Panels Start -->
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> Pilotos</span>
                    </div>
                    <%if not RS.EOF then%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     <span class="btn-group">
                                        ...
                                        <a href="muepil1.asp?UserID=<%  = RS("id")%>" class="btn btn-small"><i class="icon-search"></i>Editar</a> 
                                        <a href="borrarpiloto.asp?UserID=<%  = RS("id")%>" class="btn btn-small"><i class="icon-trash"></i>Borrar</a>
                                     </span>
                                   </td>
                                </tr>
								<%
