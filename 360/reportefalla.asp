...
%>
<head>
<meta content="text/html" charset="utf-8/iso-8859-1" />
<!-- Viewport Metatag -->
                ...
                <!-- Panels Start -->
                      ...
                      <form class="mws-form" action="widgets.html">
                            <div class="mws-form-cols clearfix">
                                    <div class="mws-form-col-2-8 alpha">
                                        <label class="mws-form-label"><span class="white">Fecha Inicial</span></label>
                                        <div class="mws-form-item large">
                                            <input type='text' class="mws-datepicker"  name='inicial' id='inicial' value="<%=date %>"/>
                                        </div>
                                    </div>
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label"><span class="white">Fecha Final</span></label>
                                        <div class="mws-form-item large">
                                           <input type='text' class="mws-datepicker"  name='final' id='final' value="<%=date %>"/>
                                        </div>
                                    </div>
                                  
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label"><span class="white">Flota</span></label>
                                        <div class="mws-form-item large">
                                        	<select id="flota">
                                            	<%llenaFlota%>
                                            </select>
                  ...
                  <div class="mws-panel grid_8 mws-collapsible mws-collapsed">     
                   <div class="mws-panel-header" >
                    	<span>Fallas Por Clasificaci&oacute;n</span>
                    </div>
...
//        });	
        ...
        ifremenew.innerHTML = "<iframe src='mostrarReportefalla.asp?flota="+$("#flota").val()+"&inicial="+ $("#inicial").val() +"&final="+ $("#final").val() +"' style='border: none; width:100%; height:100%; background-color:transparent;' id='mostrarFallas'></iframe>";
