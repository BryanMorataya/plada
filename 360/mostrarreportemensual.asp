...
inicial = Request.QueryString("mes")
final = Request.QueryString("mes1")
Dim Conn ' Open Database Connection
	...
	Conn.Open DSN
	quev = session("empn")
	     SQL="SELECT fecha,unidad,fechaOperacion FROM ichequeos where month(fecha) = "&inicial&" and year(fecha)="&final&" "
...
<body style="background-color:transparent;">
    ...
    <div class="mws-panel-body no-padding">
        ...
        <thead><tr><th>Fecha</th><th>Unidad</th><th>Fecha De Operacion</th></tr></thead>
    	<%While Not Rs.Eof%>
        <tr id="<%=RS("unidad")%>">
        	<td><%=RS("fecha")%></td>
            <td><%=RS("unidad")%></td>
