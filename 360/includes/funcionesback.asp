...
Sub tipovehl(varia)
   if cint(varia) = 1 then
       Response.Write("<option selected value = 1>Comercial</option>")
       Response.Write("<option value = 2>Camion</option>")
       Response.Write("<option value = 3>Bus</option>")
       Response.Write("<option value = 4>Maquinaria</option>")
       Response.Write("<option value = 5>Motocicleta</option>")
   end if
   if cint(varia) = 2 then
       Response.Write("<option value = 1>Comercial</option>")
       Response.Write("<option selected value = 2>Camion</option>")
       Response.Write("<option value = 3>Bus</option>")
       Response.Write("<option value = 4>Maquinaria</option>")
       Response.Write("<option value = 5>Motocicleta</option>")
   end if
   if cint(varia) = 3 then
       Response.Write("<option value = 1>Comercial</option>")
       Response.Write("<option value = 2>Camion</option>")
       Response.Write("<option selected value = 3>Bus</option>")
       Response.Write("<option value = 4>Maquinaria</option>")
       Response.Write("<option value = 5>Motocicleta</option>")
   end if
   if cint(varia) = 4 then
       ...
       Response.Write("<option value = 2>Camion</option>")
       Response.Write("<option value = 3>Bus</option>")
       Response.Write("<option selected value = 4>Maquinaria</option>")
       Response.Write("<option value = 5>Motocicleta</option>")   
   end if
   if cint(varia) = 5 then
       ...
       Response.Write("<option value = 3>Bus</option>")
       Response.Write("<option value = 4>Maquinaria</option>")
       Response.Write("<option selected value = 5>Motocicleta</option>")
   end if
End Sub
...
conn.Open DSN
Set RSx = Server.CreateObject("ADODB.Recordset")
RSx.Open "SELECT id,nombre from empresas where id =" & varia,Conn, 1,3
if not RSx.eof then
