                            ...
                            <tbody>
							 ...
							 %>
                                <tr>
                                    <td><% = RS("ID")%></td>
                                    <td><% = RS("rol")%></td>
                                    <td><span class="btn-group"><a href="detrol.asp?UserID=<%  = RS("ID")%>" class="btn btn-small"><i class="icon-search"></i>Detalle</a> 
                                      <a href="delrol.asp?UserID=<%  = RS("ID")%>" class="btn btn-small"><i class="icon-trash"></i>Borrar</a>
                                      <a href="adrol.asp" class="btn btn-small"><i class="icon-pencil-2"></i>Nuevo</a></span></td>
                                </tr>
								<%
								RS.MoveNext
								loop
